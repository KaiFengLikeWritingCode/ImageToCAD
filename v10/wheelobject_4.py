...
L_left_top_xie = Line(x1=None, y1=None, x2=None, y2=168)
geom_objects.append(L_left_top_xie)

# 4 左下斜线（连接左下小倒角 和 左下第一个大圆弧）
L_left_bottom_xie = Line(x1=None, y1=None, x2=None, y2=10)
geom_objects.append(L_left_bottom_xie)


# 5 右上斜线
L_right_top_xie = Line(x1=None, y1=None, x2=None, y2=68 + 135 - 25)
geom_objects.append(L_right_top_xie)

# 6 右下斜线
L_right_bottom_xie = Line(x1=None, y1=None, x2=None, y2=68 + 10)
...
# constraint_list.append({'type':'point_distance_x', 'p1':7, 'which1':0, 'p2':8, 'which2':0, 'value':0})
