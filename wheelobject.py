...
A_topleft_chamfer = Arc(cx=None, cy=None, r=5.0,
                        theta1=math.radians(12.0), theta2=math.radians(90))  # small chamfer
...
# L_left_top_h = Line(x1=0.0, y1=178.0, x2=None, y2=178.0)
...
A_left_bottom_cham = Arc(cx=None, cy=None, r=5.0,
                         theta1=math.radians(270.0), theta2=math.radians(360-12.0))
