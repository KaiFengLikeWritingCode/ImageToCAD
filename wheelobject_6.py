...
constraint_list += [
    ...
    {'type':'coincident','p1':12,'which1':0,'p2':13,'which2':1},
...
constraint_list += [
    ...
    {'type':'tangent_at_arc_to_arc','Aarc':12,'Barc':13,'a_end':True,'b_end':False,'same_direction':True},  # b12 ↔ b13
    {'type':'tangent_at_arc_to_arc','Aarc':13,'Barc':14,'a_end':True,'b_end':False,'same_direction':True},  # b13 ↔ b14

    {'type':'tangent_at_arc_to_arc','Aarc':15,'Barc':16,'a_end':True,'b_end':False,'same_direction':True},  # b15 ↔ b16
    {'type':'tangent_at_arc_to_arc','Aarc':16,'Barc':17,'a_end':True,'b_end':False,'same_direction':True},  # b16 ↔ b17
    {'type':'tangent_at_arc_to_arc','Aarc':17,'Barc':18,'a_end':True,'b_end':False,'same_direction':True},  # b17 ↔ b18
]
